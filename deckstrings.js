//
// deckstrings 2.0.0
// https://github.com/HearthSim/npm-deckstrings
//
...
var D__Git_deckstring_node_modules_varint = {
    encode: encode_1
  , decode: decode
...
var BufferWriter = /** @class */ (function (_super) {
    ...
    BufferWriter.prototype.varint = function (value) {
        D__Git_deckstring_node_modules_varint.encode(value, this.buffer, this.index);
        this.next(D__Git_deckstring_node_modules_varint.encode.bytes);
    };
...
var BufferReader = /** @class */ (function (_super) {
    ...
    BufferReader.prototype.nextVarint = function () {
        var value = D__Git_deckstring_node_modules_varint.decode(this.buffer, this.index);
        this.next(D__Git_deckstring_node_modules_varint.decode.bytes);
        return value;
    };
    return BufferReader;
}(Iterator));
